...
team add a.tagger.white
team add a.tagger.white.crouch
team add a.tagger.yellow
team add a.tagger.yellow.crouch
team add x.player
...
team modify a.tagger.white color white
team modify a.tagger.white.crouch color white
team modify a.tagger.yellow color yellow
team modify a.tagger.yellow.crouch color yellow
...
team modify a.tagger.white.crouch suffix {"text": "↓","color": "#7D5300"}
team modify a.tagger.yellow.crouch suffix {"text": "↓","color": "#7D5300"}
...
team modify a.tagger.white collisionRule never
team modify a.tagger.white.crouch collisionRule never
team modify a.tagger.yellow collisionRule never
team modify a.tagger.yellow.crouch collisionRule never
...
team modify a.tagger.white nametagVisibility always
team modify a.tagger.white.crouch nametagVisibility never
team modify a.tagger.yellow nametagVisibility always
team modify a.tagger.yellow.crouch nametagVisibility never
