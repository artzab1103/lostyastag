...
execute as @a[tag=tag.recieve] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run title @a[team = !menu_tagger, team = !menu] subtitle [{"text":"по воле ","color":"#00AAAA"},{"text":"админа","color":"#00FFFF","bold":true}]
...
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s playtime.title.trigger -4
#execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 1 1.5
...
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={playtime=..-1}] playtime 0
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run function tag:tag_lightning
...
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run tellraw @a[team = !menu_tagger, team = !menu] [{"text":"🔥 ","color":"gold"},{"selector":"@s","color":"aqua","bold":false},{"text":" догнал ","color":"dark_aqua"},{"text":"🗡","color":"yellow"},{"selector":"@a[tag=tag.recieve]","color":"gold","bold":true}]
...
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run tag @s remove afk
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={playtime.title.reason=-2}] playtime.title.anim_cnt -20
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={playtime.title.reason=-2}] playtime.title.reason -2
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run playsound minecraft:entity.experience_orb.pickup player @s[scores={tagger_timer=..100}] ~ ~ ~ 1 1.5
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={tagger_timer=10..40}] playtime.title.trigger -3
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players add @s[scores={tagger_timer=10..40}] playtime 15
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={tagger_timer=..9}] playtime.title.trigger -5
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players add @s[scores={tagger_timer=..9}] playtime 40
execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible] run scoreboard players set @s[scores={tagger_timer=1..}] tagger_timer 0
