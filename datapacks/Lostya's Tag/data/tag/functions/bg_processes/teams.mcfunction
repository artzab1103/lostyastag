## Tagged people
execute as @a[team=!a.tagger.white, tag=!safezoned, tag=tagger, predicate=!tag:sneaking, scores={tagger_timer=1..2}] at @s run team join a.tagger.white
execute as @a[team=!a.tagger.yellow, tag=!safezoned, tag=tagger, predicate=!tag:sneaking, scores={tagger_timer=3}] at @s run team join a.tagger.yellow
execute as @a[team=!a.tagger, tag=!safezoned, tag=tagger, predicate=!tag:sneaking, scores={tagger_timer=4..}] at @s run team join a.tagger

execute as @a[team=!a.tagger.white.crouch, tag=!safezoned, tag=tagger, predicate=tag:sneaking, scores={tagger_timer=1..2}] at @s run team join a.tagger.white.crouch
execute as @a[team=!a.tagger.yellow.crouch, tag=!safezoned, tag=tagger, predicate=tag:sneaking, scores={tagger_timer=3}] at @s run team join a.tagger.yellow.crouch
execute as @a[team=!a.tagger.crouch, tag=!safezoned, tag=tagger, predicate=tag:sneaking, scores={tagger_timer=4..}] at @s run team join a.tagger.crouch
...
#execute as @a[tag=!safezoned] run team join x.player @s[team=!a.tagger.white.crouch,team=!a.tagger.white,team=!a.tagger.yellow.crouch,team=!a.tagger.yellow,team=!a.tagger.crouch,team=!a.tagger, team = !z.othergm.tagger, team = !z.othergm, team=!y.safezoned.tagger, team = !menu, team = !menu_tagger, team = !x.player]
