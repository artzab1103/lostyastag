...
## dash
execute as @a[scores={stat.speed2=255..}, nbt={OnGround:1b}] at @s run particle dust 1 1 1 .5 ~ ~.2 ~ .2 0 .2 0 50

execute as @a[tag = !tagger, tag = !afk, tag = !safezoned, scores={stat.speed2=255..}, tag =!dash, gamemode=adventure] if entity @a[tag=tagger, tag=!afk, tag=!safezoned, gamemode=adventure] at @s run scoreboard players set @s playtime.title.trigger 6
execute as @a[tag = !tagger, tag = !afk, tag = !safezoned, scores={stat.speed2=255..}, tag =!dash, gamemode=adventure] if entity @a[tag=tagger, tag=!afk, tag=!safezoned, gamemode=adventure] at @s run scoreboard players add @s playtime 2
execute as @a[tag = !tagger, tag = !afk, tag = !safezoned, scores={stat.speed2=255..}, tag =!dash, gamemode=adventure] if entity @a[tag=tagger, tag=!afk, tag=!safezoned, gamemode=adventure] at @s run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ .25 2
execute as @a[tag = !tagger, tag = !afk, tag = !safezoned, scores={stat.speed2=255..}, tag =!dash, gamemode=adventure] if entity @a[tag=tagger, tag=!afk, tag=!safezoned, gamemode=adventure] at @s run tag @s add dash
...
## кчау
execute as @a[scores={stat.speed2=400..}, nbt={OnGround:1b}] at @s run particle dust 1 1 .5 .5 ~ ~.2 ~ .3 0 .3 0 100
